...
A highly customizable armor and item durability HUD mod for Minecraft 1.21.11 (Fabric).
...
All settings are saved to `.minecraft/config/oneauras-armor-hud.json` and persist between game sessions.

Access the config screen through **Mod Menu** or your mod configuration tool.

### Color Format
Colors use standard hex format:
- `#RRGGBB` - 6-character (full opacity)
- `#AARRGGBB` - 8-character (with alpha/transparency)
